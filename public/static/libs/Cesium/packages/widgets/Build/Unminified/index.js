...
import { Check as Check3, destroyObject as destroyObject4, getElement as getElement2 } from "@cesium/engine";
...
function getPickTileset(viewModel) {
  return function(e) {
    ...
    if (defined7(pick) && pick.primitive instanceof Cesium3DTileset) {
    ...
    set: function(value) {
      ...
      if (value) {
        that._eventHandler.setInputAction(function(e) {
          ...
          } else if (defined7(picked) && defined7(picked.content)) {
            that.feature = void 0;
            that.tile = picked.content.tile;
          } else {
            that.feature = void 0;
          ...
          if (showOnlyPickedTileDebugLabel && defined7(picked) && defined7(picked.content)) {
            let position;
            if (scene.pickPositionSupported) {
              position = scene.pickPosition(e.endPosition);
              if (defined7(position)) {
...
Object.defineProperties(Cesium3DTilesInspectorViewModel.prototype, {
  ...
  feature: {
    ...
    set: function(feature) {
      ...
      if (defined7(currentFeature) && !currentFeature.content.isDestroyed()) {
        if (!this.colorize && defined7(this._style)) {
          currentFeature.color = defined7(this._style.color) ? this._style.color.evaluateColor(currentFeature, scratchColor) : Color2.WHITE;
        } else {
  ...
  tile: {
    ...
    set: function(tile) {
      ...
      if (defined7(currentTile) && !currentTile.isDestroyed() && !hasFeatures(currentTile.content)) {
        currentTile.color = oldColor;
        this._scene.requestRender();
      }
      if (defined7(tile) && !hasFeatures(tile.content)) {
...
Cesium3DTilesInspectorViewModel.prototype.compileStyle = function() {
  ...
  if (!defined7(tileset) || this.styleString === JSON.stringify(tileset.style)) {
    return;
  }
  this._editorError = "";
  try {
...
function BaseLayerPickerViewModel(options) {
  ...
  const imageryProviders = knockout_default.pureComputed(function() {
    ...
    for (i = 0; i < providers.length; i++) {
      ...
      if (defined8(categories[category])) {
  ...
  knockout_default.defineProperty(this, "buttonTooltip", function() {
    ...
    const imageryTip = defined8(selectedImagery) ? selectedImagery.name : void 0;
    const terrainTip = defined8(selectedTerrain) ? selectedTerrain.name : void 0;
    if (defined8(imageryTip) && defined8(terrainTip)) {
      return `${imageryTip}
${terrainTip}`;
    } else if (defined8(imageryTip)) {
      return imageryTip;
    }
    return terrainTip;
  });
  ...
  knockout_default.defineProperty(this, "selectedTerrain", {
    ...
    set: function(value) {
      ...
      if (defined8(newProvider) && !defined8(newProvider.then)) {
...
import { defined as defined10, DeveloperError as DeveloperError8 } from "@cesium/engine";
function ProviderViewModel(options) {
  if (!defined10(options.name)) {
    throw new DeveloperError8("options.name is required.");
  }
  if (!defined10(options.tooltip)) {
    throw new DeveloperError8("options.tooltip is required.");
  }
  if (!defined10(options.iconUrl)) {
  ...
  if (!defined10(creationCommand.canExecute)) {
...
function FullscreenButtonViewModel(fullscreenElement, container) {
  ...
  this._fullscreenElement = getElement5(fullscreenElement) ?? ownerDocument.body;
  ...
  fullscreenElement: {
    ...
    set: function(value) {
      if (!(value instanceof Element)) {
        throw new DeveloperError11("value must be a valid Element.");
      }
...
function FullscreenButton(container, fullscreenElement) {
  ...
  container = getElement6(container);
...
function adjustSuggestionsScroll(viewModel, focusedItemIndex) {
  const container = getElement7(viewModel._viewContainer);
...
function Geocoder(options) {
  ...
  const container = getElement8(options.container);
...
function I3SBuildingSceneLayerExplorerViewModel(i3sProvider) {
  ...
  for (let i = 0; i < sublayers.length; i++) {
    ...
    if (defined17(topLayer) && (isOverview(topLayer) || !defined17(this.viewModel.defaultLayer) && isFullModel(topLayer))) {
...
function I3SBuildingSceneLayerExplorer(containerId, i3sProvider) {
  ...
  Check4.defined("i3sProvider", i3sProvider);
  ...
  if (defined18(viewModel.defaultLayer)) {
...
import { defined as defined19, DeveloperError as DeveloperError15 } from "@cesium/engine";
function HomeButtonViewModel(scene, duration) {
  if (!defined19(scene)) {
    throw new DeveloperError15("scene is required.");
  }
  this._scene = scene;
...
Object.defineProperties(HomeButtonViewModel.prototype, {
  ...
  duration: {
    ...
    set: function(value) {
      if (defined19(value) && value < 0) {
        throw new DeveloperError15("value must be positive.");
      }
...
function NavigationHelpButton(options) {
  if (!defined21(options) || !defined21(options.container)) {
    throw new DeveloperError17("options.container is required.");
  }
  const container = getElement10(options.container);
  ...
  mouseIcon.src = buildModuleUrl3("Widgets/Images/NavigationHelp/Mouse.svg");
  ...
  touchIcon.src = buildModuleUrl3("Widgets/Images/NavigationHelp/Touch.svg");
  ...
  clickInstructions.innerHTML = `            <table>                <tr>                    <td><img src="${buildModuleUrl3(
    "Widgets/Images/NavigationHelp/MouseLeft.svg"
  )}" width="48" height="48" /></td>                    <td>                        <div class="cesium-navigation-help-pan">Pan view</div>                        <div class="cesium-navigation-help-details">Left click + drag</div>                    </td>                </tr>                <tr>                    <td><img src="${buildModuleUrl3(
    "Widgets/Images/NavigationHelp/MouseRight.svg"
  )}" width="48" height="48" /></td>                    <td>                        <div class="cesium-navigation-help-zoom">Zoom view</div>                        <div class="cesium-navigation-help-details">Right click + drag, or</div>                        <div class="cesium-navigation-help-details">Mouse wheel scroll</div>                    </td>                </tr>                <tr>                    <td><img src="${buildModuleUrl3(
  ...
  touchInstructions.innerHTML = `            <table>                <tr>                    <td><img src="${buildModuleUrl3(
    "Widgets/Images/NavigationHelp/TouchDrag.svg"
  )}" width="70" height="48" /></td>                    <td>                        <div class="cesium-navigation-help-pan">Pan view</div>                        <div class="cesium-navigation-help-details">One finger drag</div>                    </td>                </tr>                <tr>                    <td><img src="${buildModuleUrl3(
    "Widgets/Images/NavigationHelp/TouchZoom.svg"
  )}" width="70" height="48" /></td>                    <td>                        <div class="cesium-navigation-help-zoom">Zoom view</div>                        <div class="cesium-navigation-help-details">Two finger pinch</div>                    </td>                </tr>                <tr>                    <td><img src="${buildModuleUrl3(
    "Widgets/Images/NavigationHelp/TouchTilt.svg"
  )}" width="70" height="48" /></td>                    <td>                        <div class="cesium-navigation-help-rotate">Tilt view</div>                        <div class="cesium-navigation-help-details">Two finger drag, same direction</div>                    </td>                </tr>                <tr>                    <td><img src="${buildModuleUrl3(
...
import { defined as defined22, Event as Event3 } from "@cesium/engine";
...
function InfoBoxViewModel() {
  ...
  knockout_default.defineProperty(this, "_bodyless", {
    get: function() {
      return !defined22(this.description) || this.description.length === 0;
    }
  });
}
...
function InfoBox(container) {
  ...
  container = getElement11(container);
  ...
  frame.addEventListener("load", function() {
    ...
    cssLink.href = buildModuleUrl4("Widgets/InfoBox/InfoBoxDescription.css");
      ...
      function(value) {
        ...
        if (firstElementChild !== null && frameContent.childNodes.length === 1) {
          ...
          if (style !== null) {
            ...
            if (defined23(color) && color.alpha !== 0) {
...
InfoBox.prototype.destroy = function() {
  ...
  if (defined23(this._descriptionSubscription)) {
...
function PerformanceWatchdogViewModel(options) {
  if (!defined24(options) || !defined24(options.scene)) {
    throw new DeveloperError18("options.scene is required.");
  }
  this._scene = options.scene;
...
PerformanceWatchdogViewModel.prototype.destroy = function() {
  ...
  return destroyObject15(this);
};
var PerformanceWatchdogViewModel_default = PerformanceWatchdogViewModel;

// packages/widgets/Source/PerformanceWatchdog/PerformanceWatchdog.js
function PerformanceWatchdog(options) {
  if (!defined25(options) || !defined25(options.container)) {
    throw new DeveloperError19("options.container is required.");
  }
  if (!defined25(options.scene)) {
    throw new DeveloperError19("options.scene is required.");
  }
  const container = getElement12(options.container);
...
function ProjectionPickerViewModel(scene) {
  ...
  this._eventHelper.add(scene.preRender, function() {
    that._flightInProgress = defined26(scene.camera._currentFlight);
  });
...
function ProjectionPicker(container, scene) {
  ...
  if (!defined27(scene)) {
    throw new DeveloperError21("scene is required.");
  }
...
import { Color as Color4, defined as defined28, JulianDate as JulianDate4 } from "@cesium/engine";
...
TimelineTrack.prototype.render = function(context, renderState) {
  ...
  if (JulianDate4.lessThan(startInterval, spanStart) && JulianDate4.greaterThan(stopInterval, spanStop)) {
    ...
    for (x = 0; x < renderState.timeBarWidth; ++x) {
      ...
      if (!defined28(start) && JulianDate4.greaterThanOrEquals(currentTime, startInterval)) {
        start = x;
      } else if (!defined28(stop2) && JulianDate4.greaterThanOrEquals(currentTime, stopInterval)) {
        stop2 = x;
      }
    }
...
function Timeline(container, clock) {
  if (!defined29(container)) {
    throw new DeveloperError22("container is required.");
  }
  if (!defined29(clock)) {
    throw new DeveloperError22("clock is required.");
  }
  container = getElement14(container);
  const ownerDocument = container.ownerDocument;
...
Timeline.prototype.zoomTo = function(startTime, stopTime) {
  if (!defined29(startTime)) {
    throw new DeveloperError22("startTime is required.");
  }
  if (!defined29(stopTime)) {
    throw new DeveloperError22("stopTime is required");
  }
  if (JulianDate5.lessThanOrEquals(stopTime, startTime)) {
    throw new DeveloperError22("Start time must come before end time.");
  }
...
Timeline.prototype.updateFromClock = function() {
  ...
  if (defined29(this._scrubElement)) {
    const seconds = JulianDate5.secondsDifference(
      this._scrubJulian,
      this._startJulian
    );
  ...
  if (defined29(this._timelineDragLocation)) {
...
function SceneModePickerViewModel(scene, duration) {
  if (!defined30(scene)) {
    throw new DeveloperError23("scene is required.");
  }
  this._scene = scene;
  const that = this;
...
Object.defineProperties(SceneModePickerViewModel.prototype, {
  ...
  duration: {
    ...
    set: function(value) {
      if (value < 0) {
        throw new DeveloperError23("duration value must be positive.");
      }
      this._duration = value;
    }
  },
...
function SceneModePicker(container, scene, duration) {
  if (!defined31(container)) {
    throw new DeveloperError24("container is required.");
  }
  if (!defined31(scene)) {
...
function SelectionIndicatorViewModel(scene, selectionIndicatorElement, container) {
  ...
  if (!defined32(selectionIndicatorElement)) {
    throw new DeveloperError25("selectionIndicatorElement is required.");
  }
  if (!defined32(container)) {
  ...
  knockout_default.defineProperty(this, "isVisible", {
    get: function() {
      return this.showSelection && defined32(this.position);
    }
  });
...
SelectionIndicatorViewModel.prototype.update = function() {
  if (this.showSelection && defined32(this.position)) {
    const screenPosition = this.computeScreenSpacePosition(
      this.position,
      screenSpacePos
    );
    if (!defined32(screenPosition)) {
      this._screenPositionX = offScreen;
      this._screenPositionY = offScreen;
    } else {
      const container = this._container;
...
function VoxelInspectorViewModel(scene) {
  Check6.typeOf.object("scene", scene);
  this._scene = scene;
  ...
  function addProperty(options) {
    ...
    if (defined36(getPrimitiveFunction)) {
    ...
    knockout_default.defineProperty(that, name, {
      ...
      set: function(value) {
        ...
        knock(value);
        if (defined36(setPrimitiveFunction) && defined36(that._voxelPrimitive)) {
  ...
  addProperty({
    ...
    initialValue: -CesiumMath2.PI_OVER_TWO,
    getPrimitiveFunction: function() {
...
Object.defineProperties(VoxelInspectorViewModel.prototype, {
  ...
  voxelPrimitive: {
    ...
    set: function(voxelPrimitive) {
      if (defined36(this._customShaderCompilationRemoveCallback)) {
        this._customShaderCompilationRemoveCallback();
      }
      if (!defined36(voxelPrimitive)) {
        return;
      }
...
VoxelInspectorViewModel.prototype.compileShader = function() {
  if (defined36(this._voxelPrimitive)) {
...
function VoxelInspector(container, scene) {
  Check7.defined("container", container);
...
function pickEntity(viewer, e) {
  ...
  if (defined37(picked)) {
    ...
    if (picked instanceof Cesium3DTileFeature2 || picked instanceof Cesium3DTileVectorFeature) {
      return new Entity({
  ...
  if (defined37(viewer.scene.globe)) {
...
function linkTimelineToDataSourceClock(timeline, dataSource) {
  if (defined37(dataSource)) {
    const dataSourceClock = dataSource.clock;
    if (defined37(dataSourceClock) && defined37(timeline)) {
...
var cartesian3Scratch = new Cartesian33();
function pickImageryLayerFeature(viewer, windowPosition) {
  ...
  if (!defined37(imageryLayerFeaturePromise)) {
    return;
  }
  ...
  imageryLayerFeaturePromise.then(
    function(features) {
      ...
      if (!defined37(features) || features.length === 0) {
...
function enableVRUI(viewer, enabled) {
  ...
  if (defined37(geocoder)) {
    geocoder.container.style.visibility = visibility;
  }
  if (defined37(homeButton)) {
    homeButton.container.style.visibility = visibility;
  }
  if (defined37(sceneModePicker)) {
    sceneModePicker.container.style.visibility = visibility;
  }
  if (defined37(projectionPicker)) {
    projectionPicker.container.style.visibility = visibility;
  }
  if (defined37(baseLayerPicker)) {
    baseLayerPicker.container.style.visibility = visibility;
  }
  if (defined37(animation)) {
    animation.container.style.visibility = visibility;
  }
  if (defined37(timeline)) {
    timeline.container.style.visibility = visibility;
  }
  if (defined37(fullscreenButton) && fullscreenButton.viewModel.isFullscreenEnabled) {
    fullscreenButton.container.style.visibility = visibility;
  }
  if (defined37(infoBox)) {
    infoBox.container.style.visibility = visibility;
  }
  if (defined37(selectionIndicator)) {
    selectionIndicator.container.style.visibility = visibility;
  }
  if (viewer._container) {
    const right = enabled || !defined37(fullscreenButton) ? 0 : fullscreenButton.container.clientWidth;
    viewer._vrButton.container.style.right = `${right}px`;
    viewer.forceResize();
  }
}
function Viewer(container, options) {
  if (!defined37(container)) {
    throw new DeveloperError29("container is required.");
  }
  container = getElement20(container);
  options = options ?? Frozen3.EMPTY_OBJECT;
  if (options.globe === false && defined37(options.baseLayer) && options.baseLayer !== false) {
    throw new DeveloperError29("Cannot use baseLayer when globe is disabled.");
  }
  const createBaseLayerPicker = (!defined37(options.globe) || options.globe !== false) && (!defined37(options.baseLayerPicker) || options.baseLayerPicker !== false);
  if (!createBaseLayerPicker && defined37(options.selectedImageryProviderViewModel)) {
  ...
  if (!createBaseLayerPicker && defined37(options.selectedTerrainProviderViewModel)) {
    throw new DeveloperError29(
  ...
  if (defined37(options.clockViewModel)) {
  ...
  const cesiumWidget = new CesiumWidget(cesiumWidgetContainer, {
    baseLayer: createBaseLayerPicker && defined37(options.selectedImageryProviderViewModel) || defined37(options.baseLayer) || defined37(options.imageryProvider) ? false : void 0,
    clock,
    ...
    creditContainer: defined37(options.creditContainer) ? options.creditContainer : bottomContainer,
  ...
  if (!defined37(options.selectionIndicator) || options.selectionIndicator !== false) {
  ...
  let infoBox;
  if (!defined37(options.infoBox) || options.infoBox !== false) {
  ...
  let geocoder;
  if (!defined37(options.geocoder) || options.geocoder !== false) {
    ...
    } else if (defined37(options.geocoder) && typeof options.geocoder !== "boolean") {
  ...
  let homeButton;
  if (!defined37(options.homeButton) || options.homeButton !== false) {
  ...
  let sceneModePicker;
  if (!scene3DOnly && (!defined37(options.sceneModePicker) || options.sceneModePicker !== false)) {
  ...
  if (defined37(options.baseLayer) && options.baseLayer !== false) {
    if (createBaseLayerPicker) {
  ...
  if (defined37(options.terrainProvider)) {
    if (createBaseLayerPicker) {
      baseLayerPicker.viewModel.selectedTerrain = void 0;
    }
    scene.terrainProvider = options.terrainProvider;
  }
  if (defined37(options.terrain)) {
    if (defined37(options.terrainProvider)) {
      throw new DeveloperError29(
  ...
  if (!defined37(options.navigationHelpButton) || options.navigationHelpButton !== false) {
    let showNavHelp = true;
    try {
      if (defined37(window.localStorage)) {
        const hasSeenNavHelp = window.localStorage.getItem(
          "cesium-hasSeenNavHelp"
        );
        if (defined37(hasSeenNavHelp) && Boolean(hasSeenNavHelp)) {
          showNavHelp = false;
        } else {
  ...
  let animation;
  if (!defined37(options.animation) || options.animation !== false) {
  ...
  let timeline;
  if (!defined37(options.timeline) || options.timeline !== false) {
  ...
  if (!defined37(options.fullscreenButton) || options.fullscreenButton !== false) {
  ...
  this._lastWidth = 0;
  this._lastHeight = 0;
  this._enableInfoOrSelection = defined37(infoBox) || defined37(selectionIndicator);
  ...
  function pickAndTrackObject(e) {
    ...
    } else if (defined37(that.trackedEntity)) {
  ...
  selectedEntity: {
    ...
    set: function(value) {
      if (this._selectedEntity !== value) {
        ...
        const selectionIndicatorViewModel = defined37(this._selectionIndicator) ? this._selectionIndicator.viewModel : void 0;
        if (defined37(value)) {
          if (defined37(selectionIndicatorViewModel)) {
            selectionIndicatorViewModel.animateAppear();
          }
        } else if (defined37(selectionIndicatorViewModel)) {
...
Viewer.prototype.resize = function() {
  ...
  const animationExists = defined37(this._animation);
  const timelineExists = defined37(this._timeline);
  cesiumWidget.resize();
  if (width === this._lastWidth && height === this._lastHeight) {
    return;
  }
  ...
  if (timelineExists && window.getComputedStyle(this._timeline.container).visibility !== "hidden") {
    ...
    if (defined37(vrButton)) {
      pixels += vrButton.container.clientWidth;
    }
    timelineStyle.right = `${pixels}px`;
    timeline.resize();
  }
  if (!timelineExists && defined37(this._fullscreenButton)) {
...
Viewer.prototype.destroy = function() {
  if (defined37(this.screenSpaceEventHandler) && !this.screenSpaceEventHandler.isDestroyed()) {
  ...
  if (defined37(this._selectionIndicator)) {
...
Viewer.prototype._dataSourceRemoved = function(dataSourceCollection, dataSource) {
  ...
  if (defined37(this.selectedEntity)) {
...
Viewer.prototype._onTick = function(clock) {
  ...
  const showSelection = defined37(selectedEntity) && this._enableInfoOrSelection;
  if (showSelection && selectedEntity.isShowing && selectedEntity.isAvailable(time)) {
    ...
    } else if (defined37(selectedEntity.position)) {
      position = selectedEntity.position.getValue(time, position);
    }
    enableCamera = defined37(position);
  }
  const selectionIndicatorViewModel = defined37(this._selectionIndicator) ? this._selectionIndicator.viewModel : void 0;
  if (defined37(selectionIndicatorViewModel)) {
    selectionIndicatorViewModel.position = Cartesian33.clone(
      position,
  ...
  const infoBoxViewModel = defined37(this._infoBox) ? this._infoBox.viewModel : void 0;
  if (defined37(infoBoxViewModel)) {
...
import { Check as Check8 } from "@cesium/engine";
function viewerCesium3DTilesInspectorMixin(viewer) {
  Check8.typeOf.object("viewer", viewer);
  const container = document.createElement("div");
...
import { defined as defined38, DeveloperError as DeveloperError30 } from "@cesium/engine";
...
function viewerDragDropMixin(viewer, options) {
  ...
  dropTarget = getElement21(dropTarget);
  Object.defineProperties(viewer, {
    /**
...
import { Frozen as Frozen5, defined as defined40, DeveloperError as DeveloperError32 } from "@cesium/engine";
