<template>
  <div id="toolbar-right">
    <div class="q-gutter-sm">
      ...
      <!-- <q-btn round color="dark" icon="flight" :size="btnSize" @click="handleBtnClick('navigation')">
        <q-tooltip> Test Flight </q-tooltip>
      </q-btn> -->
      ...
      <q-btn
        ...
        :size="btnSize"
        @click="mainStore.toggleCoordinateConvertDialog()"
      >
        <q-tooltip> 坐标转换 </q-tooltip>
      </q-btn>
    </div>
  </div>
</template>
